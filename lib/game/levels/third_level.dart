...
class ThirdLevel extends Level
{
  ...
  static List<Vector2> levelThree_waypoints = 
  [ 
    Vector2(33, 416), 
    Vector2(33, 30),
    Vector2(130,33),
   ...
   : super(
      ...
      8:  [{'type': QueenGuard, 'count': 15},{'type': QueenAnt, 'count': 1}],
      ...
      14: [{'type': CamoAnt, 'count': 30}, {'type': ArmoredAnt, 'count': 40}],
